            ...
            <div class="col-sm-12">
                ...
                <div class="ibox chat-view">
                    ...
                    <div class="ibox-title">
                        <small class="pull-right text-muted"></small>您正在${room.name }中聊天中，祝您聊天愉快！
                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="chat-users">
                                    ...
                                    <div class="users-list">
                                        <c:forEach items="${rooms }" var="bean">
											<div class="chat-user  ${bean.id==room.id?"chat-acvite":"" }" >
											 <span class="pull-right label label-primary">在线（${bean.maxman }）</span>
	                                            <img class="chat-avatar" src="${pageContext.request.contextPath}/img/room.png" alt="">
	                                            <div class="chat-user-name">
	                                                <a href="${pageContext.request.contextPath}/admin/ingrouproom?id=${bean.id }">聊天室-${bean.name }</a>
	 ...
	 $(document).ready(function(){
        ...
        function connect() {
            ...
            stompClient.connect({}, function(frame) {
                ...
                stompClient.subscribe('/userRoom/room/${room.id}', function(greeting){
        ...
        function sendMessage() {
            ...
            stompClient.send("/websocket/room", {}, JSON.stringify({ 'fromuserid':${user.id}, 'remark': message,'roomid':${room.id}}));
        }
